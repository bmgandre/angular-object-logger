...
describe('Parse multi-level filters', () => {
    ...
    describe('given a configuration containing a multi-level filter', () => {
        ...
        describe('when the parser is called with [ info, warn, error ] filters', () => {
        ...
        describe('when the parser is called with [ trace, fatal, error ] filters and HomeComponent source', () => {
        ...
        describe('when the parser is called with [ debug ] filters', () => {
