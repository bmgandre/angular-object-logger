...
describe('Parse range level filters', () => {
    ...
    describe('given a configuration containing a range level filter from trace to fatal', () => {
    ...
    describe('given a configuration containing a range level filter from info to fatal and HomeComponent source', () => {
    ...
    describe('given a configuration containing a range level filter from warn to error', () => {
    ...
    describe('given a configuration containing a range level filter from error to error', () => {
